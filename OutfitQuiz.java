...
public class OutfitQuiz {
    ...
    public OutfitQuiz() {
        // Create outfit 1
        Top o1t = new Top("Striped Hooded Sweater", "grey", "striped", "cold", "images/stripe_sweater.jpeg", "long");
        Bottom o1b = new Bottom("Blue Jeans", "blue", "denim", "neutral", "images/blue_jeans.jpeg", "long");
        Outfit o1 = new Outfit(o1t, o1b);
        o1.setOccasion("casual");

        // Create outfit 2
        Top o2t = new Top("UCSC Crewneck Sweatshirt", "maroon", "print", "cold", "images/ucsc_crew.jpeg", "long");
        Bottom o2b = new Bottom("Dark Jeans", "dark blue", "denim", "neutral", "images/dark_jeans.jpeg", "long");
        Outfit o2 = new Outfit(o2t, o2b);
        o2.setOccasion("casual");

        // Create outfit 3
        Top o3t = new Top("Grey Cardigan", "grey", "cableknit", "cold", "images/grey_cardigan.jpeg", "long");
        Bottom o3b = new Bottom("Formal Pants", "black", "plain", "neutral", "images/formal_pants.jpeg", "long");
        Outfit o3 = new Outfit(o3t, o3b);
        o3.setOccasion("formal");

        // Create outfit 4
        Top o4t = new Top("Grey Babydoll Top", "grey", "plain", "cold", "images/grey_babydoll_longsleeve.jpeg", "long");
        Bottom o4b = new Bottom("Low Rise Jeans", "blue", "denim", "neutral", "images/low_rise_jeans.jpeg", "long");
        Outfit o4 = new Outfit(o4t, o4b);
        o4.setOccasion("casual");

        // Create outfit 5
        Top o5t = new Top("Flowy Tube Top", "cream", "crepe", "warm", "images/flowy_tube.jpeg", "sleeveless");
        Bottom o5b = new Bottom("Short Denim Skirt", "light blue", "denim", "warm", "images/green_denim_skirt.jpeg", "short");
        Outfit o5 = new Outfit(o5t, o5b);
        o5.setOccasion("casual");

        // Create outfit 6
        Top o6t = new Top("Striped Tube Top", "navy", "striped", "warm", "images/stiped_tube.jpeg", "sleeveless");
        Bottom o6b = new Bottom("Lace Maxi Skirt", "white", "lace", "warm", "images/white_lace_maxi.jpeg", "long");
        Outfit o6 = new Outfit(o6t, o6b);
        o6.setOccasion("casual");

        // Create outfit 7
        Top o7t = new Top("Yellow V-Tank", "yellow", "plain", "warm", "images/yellow_v_tank.jpeg", "short");
        Bottom o7b = o3b; // Reuse formal pants from outfit 3
        Outfit o7 = new Outfit(o7t, o7b);
        o7.setOccasion("formal");

        // Create outfit 8
        Top o8t = new Top("Lace Tank Top", "white", "lace", "warm", "images/cream_lace_tank.jpeg", "short");
        Bottom o8b = new Bottom("Studded Jeans", "blue", "denim", "neutral", "images/studded_jeans.jpeg", "long");
        ...
        // These should have NO children (null left and right)
        ...
        dTree = new LinkedBinaryTree<String>("Is it cold outside?", q2a, q2b);
    }
